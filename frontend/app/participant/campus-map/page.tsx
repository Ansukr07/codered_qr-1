...
const FLOOR_3_DATA: RoomNode[] = [
    ...
    { id: '3-teach-horizontal', label: 'Teachers Cabin', type: 'office', x: 100, y: 370, width: 280, height: 80 },
    ...
    { id: '301', label: '301 (EVALUATION ROOM)', type: 'classroom', x: 280, y: 150, width: 120, height: 80 },
    { id: '302', label: '302 (EVALUATION ROOM)', type: 'classroom', x: 400, y: 150, width: 100, height: 80 },
    { id: '303', label: '303 (EVALUATION ROOM)', type: 'classroom', x: 500, y: 150, width: 100, height: 80 },
    { id: '304', label: '304 (EVALUATION ROOM)', type: 'classroom', x: 600, y: 150, width: 100, height: 80 },
    { id: '305', label: '305 (EVALUATION ROOM)', type: 'classroom', x: 700, y: 150, width: 100, height: 80 },
    { id: '306', label: 'ARYABHATA LAB (306)', type: 'lab', x: 800, y: 150, width: 200, height: 80 },

    // --- Middle Bottom ---
    // Ratan Tata Lab (310), 309, 308
    ...
    { id: '309', label: '309 (EVALUATION ROOM)', type: 'classroom', x: 740, y: 370, width: 100, height: 80 },
    { id: '308', label: '308 (EVALUATION ROOM)', type: 'classroom', x: 840, y: 370, width: 100, height: 80 },
    { id: '3-teach-4', label: 'TEACHERS OFFICE', type: 'office', x: 940, y: 370, width: 290, height: 80 },
    ...
    // --- Right Wing ---
    { id: '3-water', label: 'WATER', type: 'water', x: 1000, y: 150, width: 50, height: 50, rotation: 90 },
    ...
    { id: '3-lift-r', label: 'LIFT', type: 'lift', x: 1150, y: 170, width: 80, height: 50 },
    { id: '3-place', label: 'PLACEMENT OFFICE', type: 'office', x: 1230, y: 180, width: 80, height: 270, verticalText: true },
...
const FLOOR_4_DATA: RoomNode[] = [
    ...
    // --- Right Wing ---
    { id: '4-water', label: 'Water', type: 'water', x: 1020, y: 150, width: 30, height: 80, verticalText: true },
    ...
    { id: '4-lab-long', label: 'Lab', type: 'lab', x: 1230, y: 180, width: 80, height: 270, verticalText: true },
