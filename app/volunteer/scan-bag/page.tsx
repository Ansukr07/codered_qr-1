  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Scan for Sleeping Bag</h1>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{resource.totalQuantity - resource.distributedQuantity}/{resource.totalQuantity}</p>
              </div>
