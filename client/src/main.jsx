...
function App(){return <Routes><Route path="/login" element={<Login/>}/><Route path="/staff-login" element={<StaffLogin/>}/><Route path="/p/:username" element={<PublicProfile/>}/><Route path="/nfc/t/:token" element={<NfcProfile/>}/><Route path="/volunteer/nfc/:token" element={<RoleGuard role="volunteer"><VolunteerNfc/></RoleGuard>}/><Route path="/" element={<Guard><Dashboard/></Guard>}/><Route path="/profile" element={<Guard><Profile/></Guard>}/><Route path="/network" element={<Guard><Network/></Guard>}/><Route path="*" element={<Navigate to="/" replace/>}/></Routes>}
